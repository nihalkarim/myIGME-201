    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // 4. using example #8, add "lazy" after the last "the"
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            LinkedList<object> linkedList = null;
            LinkedListNode<object> linkedListNode;
            string[] lyrics = { "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "a", "without", "a", "roof", "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "sadnesss", "is", "the", "truth"};

            // 2. Your code here
            linkedList = new LinkedList<object>(lyrics);
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            string[] sentence = { "The", "Spain", "in", "rain", "falls", "plain", "on", "the", "mainly"};
            ...
            LinkedListNode<string> rain = sentence.Find("rain");
            LinkedListNode<string> sIn = rain.Previous;
            LinkedListNode<string> spain = sentence.Find("Spain");
            LinkedListNode<string> mainly = sentence.Find("mainly");
            LinkedListNode<string> sOn = sentence.Find("on");
            LinkedListNode<string> plain = sentence.Find("plain");

            linkedList.Remove(rain);
            linkedList.AddBefore(spain, rain);
            // "The rain Spain in falls plain on the mainly"

            linkedList.Remove(sIn);
            linkedList.AddBefore(spain, sIn);
            // "The rain in Spain falls plain on the mainly"

            linkedList.Remove(plain);
            linkedList.AddBefore(mainly, plain);
            // "The rain in Spain falls on the plain mainly"

            linkedList.Remove(mainly);
            linkedList.AddBefore(sOn, mainly);
            // "The rain in Spain falls mainly on the plain"
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            LinkedListNode<string> D = sentence.Find("D");
            LinkedListNode<string> M = sentence.Find("M");
            LinkedListNode<string> I = sentence.Find("I");
            LinkedListNode<string> T = sentence.Find("T");
            LinkedListNode<string> lastO = sentence.FindLast("O");
            LinkedListNode<string> lastR = sentence.FindLast("R");
            LinkedListNode<string> Y = sentence.Find("Y");

            //START: DORMITORY

            linkedList.Remove(I);
            linkedList.AddAfter(D, I);
            // DIORMTORY

            linkedList.Remove(T);
            linkedList.AddBefore(Y, T);
            // DIORMORTY

            linkedList.Remove(lastR);
            linkedList.Remove(T);
            linkedList.Remove(Y);
            linkedList.AddAfter(I, Y);
            linkedList.AddAfter(I, T);
            linkedList.AddAfter(I, lastR);
            // DIRTYORMO

            linkedList.Remove(lastO);
            linkedList.AddBefore(M, lastO);
            // DIRTYOROM

            LinkedListNode<string> lastR = sentence.FindLast("R");

            linkedList.Remove(lastR);
            linkedList.AddAfter(Y, lastR);
            // DIRTYROOM
